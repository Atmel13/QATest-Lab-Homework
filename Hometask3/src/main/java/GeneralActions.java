...
Поэтому, чтоб нормально проходил скрипт в Хроме и Мозиле сделал ниже без применения Actions. Достаю ссылку из соотв. локатора которая ведет на страницу "Категории"
